...
function mycount {
  ...
  grep -vh -P "^__" $shdir/htseq-count_$f.piRNAdb_mergedFeatures.txt $shdir/htseq-count_$f.piRBase_mergedFeatures.txt  > $shdir/htseq-count_$f.all_piRNA_mergedFeatures.txt
  ...
  grep -vh -P "^__" $shdir/htseq-count_$f.YRNA_mergedFeatures.txt $shdir/htseq-count_$f.notY_misc_RNA_mergedFeatures.txt  > $shdir/htseq-count_$f.misc_RNA_mergedFeatures.txt
}
...
function countOver {
  for type in {"miRBase_mature_mergedFeatures","miRBase_hairpin_mergedFeatures","miRNA_mergedFeatures","piRNAdb_mergedFeatures","piRBase_mergedFeatures","YRNA_mergedFeatures","snRNA_mergedFeatures","snoRNA_mergedFeatures","tRF_mergedFeatures","tRNAhalves_mergedFeatures","GtRNAdb_mergedFeatures","rRNA_mergedFeatures","MT_mergedFeatures","Mt_rRNA_mergedFeatures","Mt_tRNA_mergedFeatures","other(MT)_mergedFeatures","vault_RNA_mergedFeatures","lncRNA_mergedFeatures","lncipedia_hc_mergedFeatures","lncipedia_mergedFeatures","notY_misc_RNA_mergedFeatures","protein_coding_mergedFeatures","processed_pseudogene_mergedFeatures","Other_types_mergedFeatures","RepeatMasker_tRNA_mergedFeatures","RepeatMasker_rRNA_mergedFeatures","RepeatMasker_mergedFeatures","Ensembl_genes_mergedFeatures","miRBase_mature","miRBase_hairpin","miRNA","piRNAdb","piRBase","YRNA","snRNA","snoRNA","tRF","tRNAhalves","GtRNAdb","rRNA","MT","Mt_rRNA","Mt_tRNA","other(MT)","vault_RNA","lncRNA","lncipedia_hc","lncipedia","notY_misc_RNA","protein_coding","processed_pseudogene","Other_types","RepeatMasker_tRNA","RepeatMasker_rRNA","RepeatMasker","Ensembl_genes"}
  do

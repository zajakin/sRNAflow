...
# download.file(paste0('http://bigdata.ibp.ac.cn/piRBase/download/v3.0/bed/hsa.align.bed.gz'),paste0(archive,"piRBase_hsa.bed.gz"),"auto",mode = "wb")
# system(paste0("pigz -dc ",archive,"piRBase_hsa.bed.gz | awk -v OFS=\"\\t\" '{print $1,\"piRBase\",\"exon\", $2+1, $3, \".\", $6, \".\", sprintf(\"gene_id \\\"%s\\\"; transcript_id \\\"%s:%s-%s\\\"\", $4, $1, $2, $3)}' > gtf_biotypes/piRBase_2.gtf"),intern = T)

# download.file(paste0('http://bigdata.ibp.ac.cn/piRBase/download/v3.0/fasta/hsa.v3.0.fa.gz'),paste0(archive,"piRBase_hsa.fa.gz"),"auto",mode = "wb")
...
download.file(paste0('https://www.pirnadb.org/download/downloadarchive/pirna/piRNAdb.hsa.v1_7_6.fa.gz'),paste0(archive,"piRNAdb_hsa.fa.gz"),"auto",mode = "wb")
...
download.file(paste0('http://gtrnadb.ucsc.edu/genomes/eukaryota/Hsapi38/hg38-tRNAs.fa'),paste0(archive,"hg38-tRNAs.fa"),"auto",mode = "wb")
download.file(paste0('http://gtrnadb.ucsc.edu/genomes/eukaryota/Hsapi38/hg38-mature-tRNAs.fa'),paste0(archive,"hg38-mature-tRNAs.fa"),"auto",mode = "wb")
download.file(paste0('http://gtrnadb.ucsc.edu/genomes/eukaryota/Hsapi38/hg38-filtered-tRNAs.fa'),paste0(archive,"hg38-filtered-tRNAs.fa"),"auto",mode = "wb")
fa2gtf(archive,"hg38-tRNAs.fa","gtf_biotypes/","GtRNAdb")
...
download.file(paste0('https://mirbase.org/download/',specie_short,".gff3"),paste0(archive,"miRBase_",specie_short,".gff"),"auto",mode = "wb")
library("rtracklayer")
...
system(paste0("grep \"Y_RNA\\|RNY\" gtf_biotypes/misc_RNA.gtf | grep '\texon\t' > \"gtf_biotypes/YRNA.gtf\""))
gtfMergeFeatures("gtf_biotypes/YRNA.gtf")
...
system(paste0("grep -v \"Y_RNA\\|RNY\\|pRNA\" gtf_biotypes/misc_RNA.gtf | grep '\texon\t' > \"gtf_biotypes/notY_misc_RNA.gtf\""))
gtfMergeFeatures("gtf_biotypes/notY_misc_RNA.gtf")
